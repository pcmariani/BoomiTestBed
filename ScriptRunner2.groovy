...
class ScriptRunner {
    ...
    String run(String scriptName, ArrayList dataDocumentNamesArr, String propertiesFileName) {
        ...
        if (dataDocumentNamesArr != null) {
            try {
                println dataDocumentName
                // dataDocumentName = dataDocumentName.replaceAll("'","")
